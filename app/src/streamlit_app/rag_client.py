...
class RAGServiceClient:
    ...
    def get_user_status(self, user_id: int) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(f"{self.base_url}/users/{user_id}/status", headers=self.headers, timeout=10)
    ...
    def clear_cache(self, user_id: int) -> Dict[str, Any]:
        """Clear user cache."""
        try:
            response = requests.delete(f"{self.base_url}/users/{user_id}/cache", headers=self.headers, timeout=10)
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def delete_vector_db(self, user_id: int) -> Dict[str, Any]:
        ...
        try:
            response = requests.delete(f"{self.base_url}/users/{user_id}/vector-db", headers=self.headers, timeout=30)
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def check_ai_availability(self, user_id: int) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(f"{self.base_url}/users/{user_id}/ai-availability", headers=self.headers, timeout=10)
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def fix_ai_availability(self, user_id: int) -> Dict[str, Any]:
        ...
        try:
            response = requests.post(f"{self.base_url}/users/{user_id}/fix-ai-availability", headers=self.headers, timeout=120)
            response.raise_for_status()
            return response.json()
        except Exception as e:
